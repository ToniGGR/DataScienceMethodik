...
\def\myTopic{Advanced Machine Learning Project Time Series Analysis}
%\def\myMatrNr {}
\def\myKurs{WWIDS122}
\def\mySubTopic{}
\def\myAutor{Anton Geiger}
...
\begin{document}{}
    ...
    \include{chapter/Max}
    \include{chapter/Anton}
    \include{chapter/Jeremy}
